...
class PatchFamily:    # memory usage: 64B
    ...
    norm: vec3f
    contact_force: vec3f
    contact_force_dem: vec3f
    contact_force_mpm: vec3f
    v: vec3f
    ...
    @ti.func
    def _update_contact_interaction_dem(self, cforce):
        self.contact_force_dem += cforce
        #print(self.contact_force_dem)

    @ti.func
    def _update_contact_interaction_mpm(self, cforce):
        self.contact_force_mpm += cforce
