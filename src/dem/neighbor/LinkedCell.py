...
class LinkedCell(NeighborBase):
    ...
    def print_info(self):
        ...
        print("Potential contact number per particle: ", self.sims.potential_particle_num)
        print("Potential contact wall per particle: ", self.sims.wall_coordination_number, '\n')
