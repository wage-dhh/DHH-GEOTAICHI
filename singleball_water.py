...
init(device_memory_GB=45,debug=False)

dempm = DEMPM()
outputdata=r'E:\taichi_results\waterball\waterball0.001'
...
dempm.dem.add_wall(body={
    "WallType": "Plane",
    "MaterialID": 1,
    "WallCenter": ti.Vector([0.05, 0.05, 0.0]),
...
dempm.dem.add_wall(body={
    "WallType": "Plane",
    "MaterialID": 1,
    "WallCenter": ti.Vector([0., 0.05, 0.075]),
...
dempm.dem.add_wall(body={
    "WallType": "Plane",
    "MaterialID": 1,
    "WallCenter": ti.Vector([0.1, 0.05, 0.75]),
    "OuterNormal": ti.Vector([-1., 0., 0.])
})
...
dempm.dem.add_wall(body={
    "WallType": "Plane",
    "MaterialID": 1,
    "WallCenter": ti.Vector([0.05, 0.0, 0.075]),
    "OuterNormal": ti.Vector([0., 1., 0.])
})
dempm.dem.add_wall(body={
    "WallType": "Plane",
    "MaterialID": 1,
    "WallCenter": ti.Vector([0.05, 0.1, 0.075]),
    "OuterNormal": ti.Vector([0., -1., 0.])
})
