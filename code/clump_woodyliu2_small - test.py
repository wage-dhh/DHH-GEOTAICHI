...
dempm = DEMPM()
outputdata=r'H:\taichi_results\radius\4times\simulationtest_001'
...
dempm.dem.add_body_from_file(body={
                   ...
                   "Template": {"Restart": True,
                                "BodyType": "Clump",
                                "ParticleFile": r"E:\Taichi\clump\gra_radius\radius0.02\radius4.8_65\particle_test.npz",
                                "SphereFile": r"E:\Taichi\clump\gra_radius\radius0.02\radius4.8_65\sphere_test.npz",
                                "ClumpFile": r"E:\Taichi\clump\gra_radius\radius0.02\radius4.8_65\clump_test.npz"
                               }})
...
dempm.dem.add_wall(body={
                   ...
                   "WallVertice":  {
                                    ...
                                    "vertice2": ti.Vector([5.2, 0., 1.2]),
                                    "vertice3": ti.Vector([5.2, 0.12, 1.2]),
...
dempm.dem.add_wall(body={
                   ...
                   "WallVertice":  {
                                    ...
                                    "vertice2": ti.Vector([5.2, 0.48, 1.2]),
                                    "vertice3": ti.Vector([5.2, 0.6, 1.2]),
...
dempm.dem.add_wall(body={
                   ...
                   "WallVertice":  {
                                    ...
                                    "vertice3": ti.Vector([5.32, 0.12, 1.2]),
                                    "vertice4": ti.Vector([5.32, 0., 1.2])
                                   },
                   "OuterNormal": ti.Vector([1., 0., 0.])
                  })
dempm.dem.add_wall(body={
                   ...
                   "WallVertice":  {
                                    ...
                                    "vertice3": ti.Vector([5.32, 0.6, 1.2]),
                                    "vertice4": ti.Vector([5.32, 0.48, 1.2])
                                   },
                   "OuterNormal": ti.Vector([1., 0., 0.])
                  })
dempm.dem.add_wall(body={
                   ...
                   "WallVertice":  {
                                    ...
                                    "vertice2": ti.Vector([5.2, 0.12, 1.2]),
                                    "vertice3": ti.Vector([5.32, 0.12, 1.2]),
...
dempm.dem.add_wall(body={
                   ...
                   "WallVertice":  {
                                    ...
                                    "vertice3": ti.Vector([5.32, 0.48, 1.2]),
                                    "vertice4": ti.Vector([5.2, 0.48, 1.2])
                                   },
                   "OuterNormal": ti.Vector([0., -1., 0.])
                  })
...
dempm.dem.add_wall(body={
                   ...
                   "MaterialID":   0,
                   "WallVertice":  {
                                    "vertice1": ti.Vector([5.2, 0., 1.2]),
                                    "vertice2": ti.Vector([5.32, 0., 1.2]),
                                    "vertice3": ti.Vector([5.32, 0.12, 1.2]),
                                    "vertice4": ti.Vector([5.2, 0.12, 1.2])
                                   },
                   "OuterNormal": ti.Vector([0., 0., 1.])
                  })
dempm.dem.add_wall(body={
                   ...
                   "MaterialID":   0,
                   "WallVertice":  {
                                    "vertice1": ti.Vector([5.2, 0.48, 1.2]),
                                    "vertice2": ti.Vector([5.32, 0.48, 1.2]),
                                    "vertice3": ti.Vector([5.32, 0.6, 1.2]),
                                    "vertice4": ti.Vector([5.2, 0.6, 1.2])
                                   },
                   "OuterNormal": ti.Vector([0., 0., 1.])
                  })
dempm.dem.add_wall(body={
                   ...
                   "MaterialID":   0,
                   "WallVertice":  {
                                    "vertice1": ti.Vector([2, 0., 0.08]),
                                    "vertice2": ti.Vector([2, 0., 1.2]),
                                    "vertice3": ti.Vector([2, 0.6, 1.2]),
                                    "vertice4": ti.Vector([2, 0.6, 0.08])
                                   },
                   "OuterNormal": ti.Vector([-1., 0., 0.])
                  })
'''
