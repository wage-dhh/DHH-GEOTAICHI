...
init(device_memory_GB=45,debug=False, gpu_id=0)

dempm = DEMPM()
outputdata=r'H:\taichi_results\radius\4times\3.6_50_0.001'
...
dempm.dem.add_wall(body={
                   ...
                   "MaterialID":   0,
                   "WallVertice":  {
                                    "vertice1": ti.Vector([4, 0., 1.2]),
                                    "vertice2": ti.Vector([7, 0., 1.2]),
                                    "vertice3": ti.Vector([7, 0.6, 1.2]),
                                    "vertice4": ti.Vector([4, 0.6, 1.2])
                                   },
                   "OuterNormal": ti.Vector([0., 0., -1.])
                  })
dempm.dem.add_wall(body={
