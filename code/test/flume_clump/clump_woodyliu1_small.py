...
init(device_memory_GB=23,debug=False, gpu_id=0)

dempm = DEMPM()
outputdata=r'H:\taichi_results\radius\radius0.04\radius_small61'
...
dempm.dem.add_body_from_file(body={
                   ...
                   "Template": {"Restart": True,
                                "BodyType": "Clump",
                                "ParticleFile": r"E:\Taichi\clump\gra_radius\radius0.04\radius_625\particle.npz",
                                #"SphereFile": r"E:\Taichi\clump\gra_radius\radius0.4_4_50rock0.5_10clump\sphere.npz",
                                "ClumpFile": r"E:\Taichi\clump\gra_radius\radius0.04\radius625\clump.npz"
                               }})
'''
...
dempm.mpm.add_region(region=[{
                            "Name": "region1",
                            "Type": "Rectangle",
                            "BoundingBoxPoint": ti.Vector([1.8, 0, 0]),
