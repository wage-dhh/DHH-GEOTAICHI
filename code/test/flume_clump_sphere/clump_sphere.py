...
init(device_memory_GB=23,debug=False, gpu_id=1)

dempm = DEMPM()
outputdata=r'H:\taichi_results\radius\radius_test\clump_sphere'
...
dempm.dem.add_body_from_file(body={
                   ...
                   "Template":{
                               "BodyType": "Sphere",
                               "File": r"E:\Taichi\taichi2025.2.25\GeoTaichi-main2025.2.25\code\test\flume_clump_sphere\radius6_19after.txt",
                               "GroupID": 0,
                               "MaterialID":4,
...
dempm.mpm.add_element(element={
                             "ElementType":               "R8N3D",
                             "ElementSize":               ti.Vector([0.008, 0.008, 0.008])
                        })
