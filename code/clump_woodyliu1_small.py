...
dempm.dem.add_body_from_file(body={
                   ...
                   "Template": {"Restart": True,
                                "BodyType": "Clump",
                                "ParticleFile": r"E:\taichi\clump\radius_gravity\radius4.4_80\particle.npz",
                                #"SphereFile": r"E:\Taichi\clump\gra_radius\radius0.4_4_50rock0.5_10clump\sphere.npz",
                                "ClumpFile": r"E:\taichi\clump\radius_gravity\radius4.4_80\clump.npz"
                               }})
'''
...
dempm.dem.add_wall(body={
        ...
        "WallFile":r"E:\impact_force_test\patch_wall\flume_small\left_front_behind.stl",
        "Orientation":[0, 0, 1],
        "Translation": [0., 0., 0.],
        "Visualize": True
    })
dempm.dem.add_wall(body={
        ...
        "MaterialID":   0,
        "Counterclockwise":  True,
        "WallFile":r"E:\impact_force_test\patch_wall\flume_small\flume-right.stl",
        "Orientation":[0, 0, 1],
        "Translation": [0., 0., 0.],
        "Visualize": True
    })
dempm.dem.add_wall(body={
        ...
        "MaterialID":   0,
        "Counterclockwise":  True,
        "WallFile":r"E:\impact_force_test\patch_wall\flume_small\flume-bottom.stl",
        "Orientation":[0, 0, 1],
        "Translation": [0., 0., 0.],
        "Visualize": True
    })
dempm.dem.add_wall(body={
        ...
        "MaterialID":   3,
        "Counterclockwise":  True,
        "WallFile":r"E:\impact_force_test\patch_wall\flume_small\baffle-total.stl",
        "Orientation":[0, 0, 1],
        "Translation": [0., 0., 0.],
        "Visualize": True
    })
dempm.dem.add_wall(body={
        ...
        "MaterialID":   0,
        "Counterclockwise":  True,
        "WallFile":r"E:\impact_force_test\patch_wall\flume_small\flume-top.stl",
        "Orientation":[0, 0, 1],
        "Translation": [0., 0., 0.],
        "Visualize": True
    })
dempm.dem.add_wall(body={
        ...
        "MaterialID":   0,
        "Counterclockwise":  True,
        "WallFile":r"E:\impact_force_test\patch_wall\flume_small\flume-rightwater.stl",
        "Orientation":[0, 0, 1],
        "Translation": [0., 0., 0.],
        "Visualize": True
    })
...
dempm.mpm.add_region(region=[{
                            ...
                            "BoundingBoxSize": ti.Vector([0.1, 0.6, 0.3]),
