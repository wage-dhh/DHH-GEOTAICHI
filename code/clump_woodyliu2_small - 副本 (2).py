...
dempm = DEMPM()
outputdata=r'H:\taichi_results\radius\4times\simulation4435_001failure'
...
dempm.dem.add_body_from_file(body={
                   ...
                   "Template": {"Restart": True,
                                "BodyType": "Clump",
                                "ParticleFile": r"E:\Taichi\clump\gra_radius\radius0.02\radius4.4_35\particle.npz",
                                #"SphereFile": r"E:\Taichi\clump\gra_radius\radius0.02\radius4.8_65\sphere_test.npz",
                                "ClumpFile": r"E:\Taichi\clump\gra_radius\radius0.02\radius4.4_35\clump.npz"
                               }})
